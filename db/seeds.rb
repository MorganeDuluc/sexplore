...
q3 = Question.create!(content: "J'ai vraiment envie de faire l'amour, mais je sens que mon/ma partenaire est douteu(x)se.", order: 3, quiz_id: Quiz.first.id)
...
q5 = Question.create!(content: "Je suis sur(e) de vouloir perdre ma virginité avec mon/ma partaire mais je suis strésé(e) et ai(e) des questions.", order: 5, quiz_id: Quiz.first.id)
