...
Question.create!(content: "Je suis sûr(e) de vouloir perdre ma virginité avec mon/ma partaire mais je suis stressé(e) et j'ai des questions.", order: 5, quiz_id: Quiz.first.id)
...
Response.create!(content: "Trop cool, je vais pouvoir tester des positions comme j'ai pu en voir sur internet.", result: false, question_id: 1, explication: "toto")
Response.create!(content: "Sympa je vais enfin savoir ce que ça fait de jouïr.", result: false, question_id: 1, explication: "toto")
