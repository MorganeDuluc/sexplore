...
q5 = Question.create!(content: "Je suis sûr(e) de vouloir perdre ma virginité avec mon/ma partaire mais je suis stressé(e) et j'ai des questions.", order: 5, quiz_id: Quiz.first.id)
...
Response.create!(content: "Trop cool, je vais pouvoir tester des positions comme j'ai pu en voir sur internet.", result: false, question: q1, explication: "toto")
