...
q1 = Question.create!(content: "Ma première fois va être...", order: 1, quiz_id: Quiz.first.id, explication:"Tu ne sais pas conduire une voiture dès la première fois que tu essaies n'est-ce pas ? Pour le sexe c'est pareil, ça s'apprend ! Avec le temps ça deviendra de plus en plus naturel et agréable. La première fois n'est souvent pas ce que nous pensons. Tu vas te découvrir, être maladroit(e) mais tout sera de plus en plus agréable avec le temps. Les points vraiment importants sont la COMMUNICATION avec ton/ta partenaire, le RESPECT mutuel, l'écoute. Prends ton temps et n'hésite pas à dire à ton/ta partenaire ce que tu apprécies. Ne dis JAMAIS oui à ce qui ne t'apporte pas de plaisir, COMMUNIQUE, exprime tes ressentis auprès que ton/ta partenaire sexuel, que tu sois en couple ou non." )
...
q5 = Question.create!(content: "Je suis sûr(e) de vouloir perdre ma virginité avec mon/ma partenaire mais je suis stressé(e) et j'ai des questions.", order: 5, quiz_id: Quiz.first.id, explication: "La communication est la base d'une vie sexuelle épanouïe. Dès que tu as une question, tu dois en faire part à ton/ta partenaire. Ne laisse pas des blocages interférer avec la construction de ton identité sexuelle. Si il/elle n'est pas à l'écoute et se montre moqueur(se), demande toi si c'est à ce genre de personne que tu souhaites te livrer. Beaucoup de craintes surgissent avant ta première fois: avoir peur d'être nul(le), de ne pas savoir faire, de ne pas aimer, etc. Sache que la première fois n'est souvent pas très confortable, autant pour toi que ton/ta partenaire. Toutes ces questions sont normales, rassure-toi. L'essentiel est de COMMUNIQUER pour prendre confiance !")
