...
q1 = Question.create!(content: "Ma première fois va être...", order: 1, quiz_id: Quiz.first.id, explication:"Tu ne sais pas conduire une voiture dès la première fois que tu essaies n'est-ce pas ? Pour le sexe c'est pareil, ça s'apprend ! Avec le temps ça deviendra de plus en plus naturel et agréable. La première fois n'est souvent pas ce que nous pensons. Tu vas te découvrir, être maladroit(e) dans tes gestes et ce ne sera pas toujours agréable. Mais rien de grave, tout va bien ! Ce sera de plus en plus agréable avec le temps. Les points vraiment importants sont la COMMUNICATION avec ton/ta partenaire, le RESPECT mutuel, l'écoute, l'observation. Prends ton temps et n'hésite pas à dire à ton/ta partenaire ce que tu apprécies. Ne dis JAMAIS oui à ce qui ne t'apporte pas de plaisir, COMMUNIQUE, exprime tes ressentis auprès que ton/ta partenaire sexuel, que tu sois en couple ou non." )
...
q3 = Question.create!(content: "J'ai vraiment envie de faire l'amour, mais je sens que mon/ma partenaire hésite et a des doutes.", order: 3, quiz_id: Quiz.first.id, explication:"Le respect mutuel est primodial. Que tu sois dans une relation amoureuse ou non, ton/ta partenaire te confie son intimité, tu dois le/la RESPECTER. En plus d'être à l'ECOUTE, tu dois OBSERVER ses gestes. Certaines gestuelles ne trompent pas. Si tu as un doute, tu ne dois pas hésiter à demander à ton/ta partenaire pour que votre échange soit le plus agréable possible. L'acte sexuel ne consiste pas seulement à assouvir son plaisir personnel. Quand tu sens que ton/ta partenaire n'a pas à 100% envie, tu t'arrêtes, même si le NON n'est pas prononcé, si la gestuelle dit NON alors tu t'arrêtes là. Ces notions d'observation et d'écoute sont super importantes, elle représentent le consentement." )
q4 = Question.create!(content: "Mon/ma partenaire veut que nous fassions les préliminaires, cela signifie que nous devons forcément se faire un cunnilingus et/ou une fellation ?", order: 4, quiz_id: Quiz.first.id, explication:"Avant toute explication, nommons les préliminaires: le sexe non-pénétratif. Une chose préliminaire est ce qui précède et prépare une autre chose considérée comme plus importante. Hors, le sexe non-pénétratif est aussi important que le sexe pénétratif. Cela ne consiste pas seulement à faire un cunnilingus ou une fellation. En fait, tout ton corps est une zone érogène. Donc NON, le sexe non-pénétratif ne veut pas dire que tu devras faire un cunillingus ou une fellation, c'est bien plus vaste. N'oublie surtout pas que si tu n'en n'as pas envie, tu ne dois PAS le faire. TON CORPS = TES REGLES.")
q5 = Question.create!(content: "Je suis sûr(e) de vouloir perdre ma virginité avec mon/ma partenaire mais je suis stressé(e) et j'ai des questions.", order: 5, quiz_id: Quiz.first.id, explication: "La communication est la base d'une vie sexuelle épanouïe. Dès que tu as une question ou une gêne, tu dois en faire part à ton/ta partenaire. Ne laisse pas des blocages interférer avec la construction de ton identité sexuelle. Si il/elle n'est pas à l'écoute et se montre moqueur(se), demande toi si c'est à ce genre de personne que tu souhaites te livrer. Beaucoup de questions apparaissent quand il s'agit de la première fois: avoir peur d'être nul(le), de ne pas savoir faire, de ne pas aimer, etc. Sache que la première fois n'est souvent pas très confortable, autant pour toi que ton/ta partenaire. Toutes ces questions sont normales, rassure-toi. L'essentiel est de COMMUNIQUER pour prendre confiance !")

Response.create!(content: "Magique, comme dans les films romantiques", result: false, question: q1)
Response.create!(content: "Cool, je vais pouvoir tester des positions comme sur internet.", result: false, question: q1)
...
Response.create!(content: "Faire l'amour n'est pas urgent, tu lui proposes d'en parler.", result: true, question: q3)
