...
q2 = Question.create!(content: "Mon/ma partenaire a plus d'expérience que moi, il/elle doit donc prendre le dessus.", order: 2, quiz_id: Quiz.first.id, explication: "Tu ne sais pas conduire une voiture dès la première fois que tu essaies n'est-ce pas ? Pour le sexe c'est pareil, ça s'apprend ! Avec le temps ça deviendra de plus en plus naturel et agréable. La première fois n'est souvent pas ce que nous pensons. Cela peut être surprenant, tu vas te découvrir, être maladroit(e) dans tes gestes et ce ne sera pas toujours agréable.  Mais rien de grave, tout va bien ! Ce sera de plus en plus agréable avec le temps. Les points vraiment importants sont la COMMUNICATION avec ton/ta partenaire, le RESPECT mutuel, l'écoute, l'observation. Prends ton temps, du plaisir et n'hésite pas à dire à ton/ta partenaire ce que tu apprécies. Ne dis JAMAIS oui à ce qui ne t'apporte pas de plaisir, COMMUNIQUE, exprime tes ressentis auprès que ton/ta partenaire sexuel, que tu sois en couple ou non.")
